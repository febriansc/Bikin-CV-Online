...
$section->addText('CURRICULUM VITAE', 'rStyle', 'pStyle');
...
$table = $section->addTable('myOwnTableStyle');
$table->addRow();
$table->addCell(10000,$styleCell)->addText('PENGALAMAN KERJA','sStyle','pStyle');

//$section->addText('Work Experience','sStyle','pStyle');
$section->addText('-------------------------------------------------------------------------------------','rStyle','lStyle');
...
$table = $section->addTable('myOwnTableStyle');
$table->addRow();
$table->addCell(10000,$styleCell)->addText('DATA PENDIDIKAN','sStyle','pStyle');
...
$table = $section->addTable('myOwnTableStyle');
$table->addRow();
$table->addCell(10000,$styleCell)->addText('DATA KEMAMPUAN BAHASA','sStyle','pStyle');
...
$table = $section->addTable('myOwnTableStyle');
$table->addRow();
$table->addCell(10000,$styleCell)->addText('DATA KEMAMPUAN PENDUKUNG','sStyle','pStyle');
